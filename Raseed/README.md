...
## أين تجد كل ميزة
القائمة الجانبية مقسّمة إلى أقسام تُفتح بنقرة: **المخزن، بيع، شراء، الأقساط، السندات، الحسابات، تقارير الحسابات، تقارير القوائم، تقارير الأرباح، تقارير المواد، تقارير المخازن، تقارير المتابعة، الصيانة والموظفون، الإدارة**. كل شاشة تُفتح في تبويب مستقل أعلى الصفحة.
...
| الزبائن والمجهزون وتعديل الرصيد | الحسابات ← حساب الزبائن / حساب المجهزين ← زر «تعديل رصيد» |
