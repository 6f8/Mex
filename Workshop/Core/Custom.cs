...
public static class Lists
{
    ...
    public static string[] Get(string key)
    {
        ...
        if (key == "pay_methods") items = new[] { Cash }.Concat(items.Where(x => x != Cash)).ToArray();
        cache[key] = (raw, items);
        return items;
    }
...
public static class Msg
{
    ...
    {
        ("الزبون", "اسم الزبون"), ("الجهاز", "الجهاز والموديل"), ("العطل", "وصف العطل"), ("المرجع", "الرقم المرجعي"), ("الحالة", "حالة الطلب"),
